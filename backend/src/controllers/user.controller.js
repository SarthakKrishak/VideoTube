...
const getUserChannelProfile = asyncHandler(async (req, res) => {
    ...
    // Writing the mongodb Aggregation pipelines
...
// Here we will use nested pipline as in the video model we have the owner which is again a user so we have to again do the pipeline there as well
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, changeCurrentPassword, getUser, updateAccountDetails, updateUserCoverImage, updateUserAvatar, getUserChannelProfile, getWatchHistory };